    ...
    var _auth_cb = auth_cb;
     ...
     this.get_feature_type_descriptions = function (ref, feature_type_list, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "GenomeAnnotationAPI.get_feature_type_descriptions",
            [ref, feature_type_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_feature_ids = function (ref, filters, group_type, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "GenomeAnnotationAPI.get_feature_ids",
            [ref, filters, group_type], 1, _callback, _errorCallback);
    };
     ...
     this.get_features = function (ref, feature_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax(_url, "GenomeAnnotationAPI.get_features",
            [ref, feature_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_feature_publications = function (ref, feature_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax(_url, "GenomeAnnotationAPI.get_feature_publications",
            [ref, feature_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_cds_by_gene = function (ref, gene_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax(_url, "GenomeAnnotationAPI.get_cds_by_gene",
            [ref, gene_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_cds_by_mrna = function (ref, mrna_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax(_url, "GenomeAnnotationAPI.get_cds_by_mrna",
            [ref, mrna_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_gene_by_cds = function (ref, cds_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax(_url, "GenomeAnnotationAPI.get_gene_by_cds",
            [ref, cds_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_gene_by_mrna = function (ref, mrna_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax(_url, "GenomeAnnotationAPI.get_gene_by_mrna",
            [ref, mrna_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_mrna_by_cds = function (ref, cds_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax(_url, "GenomeAnnotationAPI.get_mrna_by_cds",
            [ref, cds_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_mrna_by_gene = function (ref, gene_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax(_url, "GenomeAnnotationAPI.get_mrna_by_gene",
            [ref, gene_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_mrna_exons = function (ref, mrna_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax(_url, "GenomeAnnotationAPI.get_mrna_exons",
            [ref, mrna_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_mrna_utrs = function (ref, mrna_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax(_url, "GenomeAnnotationAPI.get_mrna_utrs",
            [ref, mrna_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_summary = function (ref, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "GenomeAnnotationAPI.get_summary",
            [ref], 1, _callback, _errorCallback);
    };
     ...
     this.save_summary = function (ref, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "GenomeAnnotationAPI.save_summary",
            [ref], 1, _callback, _errorCallback);
    };
 
     this.get_feature_info_hack_for_widget = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "GenomeAnnotationAPI.get_feature_info_hack_for_widget",
