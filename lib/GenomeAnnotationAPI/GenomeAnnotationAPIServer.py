...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'GenomeAnnotationAPI'):
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_GenomeAnnotationAPI.get_feature_info_hack_for_widget,
                             name='GenomeAnnotationAPI.get_feature_info_hack_for_widget',
                             types=[dict])
        self.method_authentication['GenomeAnnotationAPI.get_feature_info_hack_for_widget'] = 'required'
